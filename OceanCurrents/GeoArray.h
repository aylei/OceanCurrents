...
struct GeoArray {
    ...
    GeoArray() : array_p_(nullptr), status_(ARRAY_STATUS_UNKNOW) {}

    GeoArray(const GeoArray& geoArray)
        : array_p_(nullptr) {
        *this = geoArray;
    }
    ...
    GeoArray& operator=(const GeoArray& ga) {
        ...
        // for const other, memcpy array data to this
    ...
    GeoArray& operator=(GeoArray&& ga) {
        ...
        // for non-const other, scramble other's array pointer to this
    ...
    /*
     * @brief get data of given (latitude, longitude)
     *
     * @param latitude 
     * @param longtitud
     */
